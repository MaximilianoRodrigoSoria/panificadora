...
<div class="productos index">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
    		<h3 class="panel-title"><?php echo __('Productos'); ?></h3>
 		</div>
		...
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link('',array('action'=>'view', $producto['Producto']['id']), array('class'=>'btn btn-default glyphicon glyphicon-search')); ?>
				<?php echo $this->Html->link(__(''), array('action' => 'edit', $producto['Producto']['id']), array('class'=>'btn btn-default glyphicon glyphicon-pencil')); ?>
		
				<?php echo $this->Form->postLink('', array('action' => 'delete', $producto['Producto']['id']), array('class' => 'btn btn-default glyphicon glyphicon-trash'), __('Estas seguro que deseas borrar el registro n°%s?', $producto['Producto']['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
		</tbody>
